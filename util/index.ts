...
const PREVIEW_SOURCES = {
  ...
  SlidingText: {
    src: "/api/sliding-text?text=Hey, I'm Jellybear!&emojis=1f419_1f43b",
    component: CoolComponents.SlidingText,
  },
  VisitorCounter: {
    src: "/api/visitor-counter?page=webapp.io",
    component: CoolComponents.VisitorCounter,
    helperText:
      "Show the number of visitors that have viewed your GitHub profile or a certain project.",
  },
  SocialMedia: {
    src: "/api/social-media?social=Facebook",
    component: CoolComponents.SocialMedia,
    helperText: "Show icons to your social media profiles.",
  },
  TopTech: {
    src: "/api/technology?technology=javascript_react_aws_html_css_python_java_nodejs_golang_elixir_mysql_postgres_mongodb_redis_aws_react_express_flask_other",
...
export { CoolComponents, PREVIEW_SOURCES, SOCIAL_MEDIA, TECHNOLOGIES, origin };
