export function getSlidingTextWithEmojis(text = "", emojiString = "") {
  return `
...
export function getWavyBanner(title = "", subtitle = "") {
  return `
...
export function getVisitorCounter(count = 0) {
  return `
...
export function getTechnologiesSvg(technologyString = "") {
  return `
